...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 mei 2025 om 11:31
...
(1, 1, 1, 'Spaghetti', 'gram', 1700),
(2, 1, 2, 'Tomato sauce', 'ml', 3400),
(3, 1, 3, 'Vegetarian minced meat', 'gram', 2550),
(4, 1, 4, 'Onion', 'piece', 17),
(5, 1, 5, 'Garlic', 'piece', 34),
(6, 1, 6, 'Herb mix', 'teaspoon', 34),
